...
<div class="container">
      ...
      <div class="jumbotron">
      	<div class="row">
	      	<div class="col-lg-10">
	      		<select id="fltr" class=form-control style="max-width: 40%">
	       	...
	       	<div class="col-lg-2">
				  ...
				  <li class="active"><a href='<spring:url value="/instanca"></spring:url>'>Popis Instanci</a></li>
				  <li><a href='<spring:url value="/instanca?form"></spring:url>'>Ubaci novu</a></li>
				</ul>
			</div>
		</div>
      </div>
