      ...
      <div class="jumbotron">
      	<div class="row">
	      	<div class="col-lg-8">
	      		...
	      		<form:form modelAttribute="kategorija" class="form-horizontal">
					<div class="form-group">
						<label for="nazivKolegija" class="col-lg-1 control-label">Naziv:</label>
						<div class="col-lg-7">
	       	...
	       	<div class="col-lg-4">
				  ...
				  <li><a href='<spring:url value="/kategorija"></spring:url>'>Popis kategorija</a></li>
				  <li class="active"><a href='<spring:url value="/kategorija?form"></spring:url>'>Ubaci novu</a></li>
				</ul>
			</div>
		</div>
      </div>
